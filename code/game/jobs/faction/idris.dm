/datum/faction/idris_incorporated
	...
	Крупнейший межзвездный банковский конгломерат 'Idris Incorporated' в рукаве Ориона
	управляется таинственной семьёй Идрис. Влияние 'Idris Incorporated'
	можно встретить почти в каждом уголке человеческого пространства с их финансированием
	практически всех видов бизнеса и предприятий. Их рискованные предприятия оплачиваются
	печально известными Идрисскими восстановительными подразделениями,
	КПБ были направлены для получения выплат от нерадивых заёмщиков.
	В последние годы они начали диверсифицировать свою деятельность, переключившись на сферу услуг.
	</p>"}
