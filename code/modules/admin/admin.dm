...
/proc/toggle_wind_paralysis(var/mob/living/target, var/mob/user)
	...
	if(check_rights(R_ADMIN|R_MOD, user))
		if (target.paralysis == 0)
			...
			target.visible_message("<font color='#002eb8'><b>OOC Информация:</b></font> <span class='warning'>[target] был выведен из игры членом администрации! Пожалуйста, приостановите всю ролевую игру, связанную с персонажем, до разрешения ситуации! Если у вас есть вопросы, обратитесь в \"Adminhelp\".</span>", SPAN_WARNING("<b>Вы были выведены из игры членом администрации! Пожалуйста, дождитесь момента, пока с вами не свяжутся!</b>"))
			...
			target.visible_message("<font color='#002eb8'><b>OOC Информация:</b></font> <font color='green'>[target] был возвращён в игру членом администрации!</font>", SPAN_WARNING("<b>Вы были возвращены в игру членом администрации!</b>"))
